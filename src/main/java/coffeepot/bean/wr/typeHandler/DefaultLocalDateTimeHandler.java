 ...
 */
public class DefaultLocalDateTimeHandler implements TypeHandler<LocalDateTime> {
    ...
    public DefaultLocalDateTimeHandler() {
        setDefaultValues();
    }

    @Override
    public LocalDateTime parse(String text, Metadata metadata) throws HandlerParseException {
    ...
    @Override
    public String toString(LocalDateTime obj, Metadata metadata) {
        if (obj == null) {
            return null;
        }
    ...
    public static void setPatternDefault(String patternDefault) {
        DefaultLocalDateTimeHandler.patternDefault = patternDefault;
    }
}
