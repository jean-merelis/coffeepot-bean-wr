 ...
 */
public class DefaultLocalTimeHandler implements TypeHandler<LocalTime> {

    protected static String patternDefault;
    public static final String CMD_SET_PATTERN = "setPattern";

    static {
        patternDefault = "HH:mm:ss";
    }

    protected String pattern;
    private DateTimeFormatter formatter;

    public DefaultLocalTimeHandler() {
        setDefaultValues();
    }

    @Override
    public LocalTime parse(String text, Metadata metadata) throws HandlerParseException {
    ...
    @Override
    public String toString(LocalTime obj, Metadata metadata) {
        if (obj == null) {
            return null;
        }
    ...
    public static void setPatternDefault(String patternDefault) {
        DefaultLocalTimeHandler.patternDefault = patternDefault;
    }
}
