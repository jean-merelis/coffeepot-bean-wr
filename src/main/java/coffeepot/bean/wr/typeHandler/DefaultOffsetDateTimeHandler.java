 ...
 */
public class DefaultOffsetDateTimeHandler implements TypeHandler<OffsetDateTime> {
    ...
    public DefaultOffsetDateTimeHandler() {
        setDefaultValues();
    }

    @Override
    public OffsetDateTime parse(String text, Metadata metadata) throws HandlerParseException {
    ...
    @Override
    public String toString(OffsetDateTime obj, Metadata metadata) {
        if (obj == null) {
            return null;
        }
    ...
    public static void setPatternDefault(String patternDefault) {
        DefaultOffsetDateTimeHandler.patternDefault = patternDefault;
    }
}
